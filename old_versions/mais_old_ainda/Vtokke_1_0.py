...
dt = pd.read_csv("catalogo.csv", delimiter =',', encoding='ISO-8859-1') #   testar encoding='cp1252'  #
...
class Player(Tk.Frame):
    ...
    def __init__(self, parent, title=None):
        ...
        lab = ttk.Label(ctrlpanel, text="Código Música: ")
        lab1 = ttk.Label(ctrlpanel, text="Próxima Música: ")
        ...
        def addList(btn):
            ...
            if codigo.get() != '':
                ...
                codigo.delete(0,'end')
                if len(fila.index)== 1:
                    lab1.configure(text = "Próxima Música: " + dt[dt.code == fila.iloc[0,0]].iloc[0,1])
        ...
        def onopen(btn):
            ...
            if len(fila.index)>= 1:
                ...
                lab1.configure(text = "Próxima Música: Nenhuma")
